...
# Update the delivered flag to indicate whether or not user can retire
r = make_update_request('cart', 'Delivered = ' + str(int(can_retire)),
                        'id = ' + str(CART_ID))

# If the request was successful
if r.status_code == 200:
    print('Successfully updated retire availability')
else:
    # Error handling (maybe retry update)
    print('Could not update retire availability')
